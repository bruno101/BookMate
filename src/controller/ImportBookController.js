        ...
        try {
            ...
            await LocalStorage.importBook(response[0].uri, response[0].name).then(
                async (newBook) => {
                    ...
                    navigation.navigate('Home', { screen: 'ReadBook', initial: false, params: { bookKey: newBook.bookKey, bookTitle: newBook.title, fileName: newBook.fileName, initialPage: "1", saveMetadata: true } })
