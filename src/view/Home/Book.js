...
const Book = (props) => {
    ...
    return (
        ...
        <TouchableOpacity onLongPress={() => setShowBottomModal(true)} onPress={() => props.goToBook(props.bookKey, props.lastLocationOpened, props.fileName)} style={{ width: "44%", marginRight: "5%", marginBottom: "4%" }}>
