    ...
    if (bookMetadata == null) {
        ...
        return (
            ...
            <View>
                ...
                <TouchableOpacity style={{ width: device.width * 0.9, height: 160, marginTop: 40, marginBottom: 40 }} onPress={() => props.goToBook(bookMetadata.bookKey, bookMetadata.fileName)}>
